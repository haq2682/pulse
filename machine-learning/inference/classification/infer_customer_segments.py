...
OUTPUT_PATH = f"s3a://{BUCKET_NAME}/machine-learning/classification/customer_segment_predictions"
MODEL_INPUT_DIR = f"s3a://{BUCKET_NAME}/machine-learning/models/customer_segments"
