...
OUTPUT_PATH = f"s3a://{BUCKET_NAME}/machine-learning/classification/review_sentiment_predictions"
MODEL_INPUT_DIR = f"s3a://{BUCKET_NAME}/machine-learning/models/review_sentiment"
