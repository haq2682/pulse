...
OUTPUT_PATH = f"s3a://{BUCKET_NAME}/machine-learning/classification/payment_success_predictions"
MODEL_INPUT_DIR = f"s3a://{BUCKET_NAME}/machine-learning/models/payment_success"
