...
def main(BUCKET_NAME, EXPORT_PLOTS=False):
    ...
    MODEL_CANDIDATES = ["RandomForestOptimized", "DecisionTree", "MultilayerPerceptron"]
    PREFERRED_MODEL = "RandomForestOptimized"
    print("=" * 60)
    ...
    export_inference_outputs_plot(
        model_name=f"payment_success_{SELECTED_MODEL}",
        predictions_df=predictions_df,
        label_column="predicted_status",
        numeric_columns=["success_probability", "confidence_score"],
