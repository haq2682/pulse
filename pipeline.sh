...
# ./pydoc.sh machine-learning/general/training/classification/train_customer_churn.py
# ./pydoc.sh machine-learning/general/inference/classification/infer_customer_churn.py

# ./pydoc.sh machine-learning/general/training/classification/train_customer_segments.py
# ./pydoc.sh machine-learning/general/inference/classification/infer_customer_segments.py

# ./pydoc.sh machine-learning/general/training/classification/train_payment_success.py
# ./pydoc.sh machine-learning/general/inference/classification/infer_payment_success.py

# ./pydoc.sh machine-learning/general/training/classification/train_review_sentiment.py
# ./pydoc.sh machine-learning/general/inference/classification/infer_review_sentiment.py

# ./pydoc.sh machine-learning/specific/training/classification/train_product_bundling.py
# ./pydoc.sh machine-learning/specific/inference/classification/infer_product_bundling.py

# ./pydoc.sh machine-learning/general/training/classification/train_cart_abandonment.py
# ./pydoc.sh machine-learning/general/inference/classification/infer_cart_abandonment.py

# ./pydoc.sh machine-learning/general/training/classification/train_stock_status.py
# ./pydoc.sh machine-learning/general/inference/classification/infer_stock_status.py

# ./pydoc.sh machine-learning/specific/training/classification/train_fulfillment_risk.py
# ./pydoc.sh machine-learning/specific/inference/classification/infer_fulfillment_risk.py

# ./pydoc.sh machine-learning/general/training/regression/train_clv.py
# ./pydoc.sh machine-learning/general/inference/regression/infer_clv.py
