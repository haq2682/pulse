...
export default function Forecasts() {
    ...
    return (
        <div className="p-6 space-y-10">
            ...
            {/* ── Page Header ──────────────────────────────────────────────────── */}
            <div>
                <h1 className="text-3xl font-bold text-gray-900">🔮 Forecasts &amp; Predictions</h1>
                <p className="text-gray-500 mt-1">
                    AI/ML inference results for this business — predictions are computed by the ML pipeline
                    and are static aggregates (not filtered by date).
                </p>
