    ...
    return (
        <div className="p-6 space-y-8">
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div>
                    <h1 className="text-3xl font-bold text-gray-900">Shipping Efficiency</h1>
                    <p className="text-gray-500 mt-1">
                        Shipping cost efficiency by country, state, and city — cost as a percentage of order value
                    </p>
                </div>
                <DateFilterBar
